...
& = &
\displaystyle \frac{4\pi\alpha^2}{xyQ^2}\eta^i
\left[
...
\begin{array}{lcl}
  ...
  =
  \Delta c_{4,q}^{(1)}(x)  - 2x\Delta c_{5,q}^{(1)}(x) 
  &=& 
  2C_F\, 2x 
  \,\mbox{,}
  \\ \\
  ...
  =
  \Delta c_{4,g}^{(1)}(x)  - 2x\Delta c_{5,g}^{(1)}(x) 
  &=& 
  0 
  \,\mbox{.}
%  %C1q
