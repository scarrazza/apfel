...
\begin{subequations}
\begin{equation}
F_1^{\rm FF,IC}(x,Q^2)= \frac{1}{2\sqrt{1+4\frac{m_c^2}{Q^2}}}e_c^2c(\chi)
\end{equation}
\begin{equation}
F_2^{\rm FF,IC}(x,Q^2)=x\left(\sqrt{1+4\frac{m_c^2}{Q^2}}\right)e_c^2c(\chi)
\end{equation}
\begin{equation}
F_3^{\rm FF,IC}(x,Q^2)= 0
\end{equation}
\end{subequations}
with:
\begin{equation}
\chi = \frac{x}{2}\left(1+\sqrt{1+4\frac{m_c^2}{Q^2}}\right)
\end{equation}
...
\begin{subequations}
\begin{equation}
F_1^{\rm FF,IC}(x,Q^2)= \frac{1}{2\sqrt{1+4\frac{m_c^2}{Q^2}}}B_c c(\chi)
\end{equation}
\begin{equation}
F_2^{\rm FF,IC}(x,Q^2)=x\left(\sqrt{1+4\frac{m_c^2}{Q^2}}\right)B_cc(\chi)
\end{equation}
\begin{equation}
F_3^{\rm FF,IC}(x,Q^2)= 2D_cc(\chi)
\end{equation}
\end{subequations}
again with:
\begin{equation}
...
\end{equation}
\begin{equation}
F_2^{\rm FF,IC}(x,Q^2)= 2x\left(1+\frac{m_c^2}{Q^2}\right)|V_{cj}|^2c(x)
\end{equation}
\begin{equation}
F_3^{\rm FF,IC}(x,Q^2)= 2|V_{cj}|^2c(x)
\end{equation}
\end{subequations}
with $j=d,s$. Note that in this case $\chi=x$.
...
therefore:
\begin{equation}
F_L^{\rm FF,IC}(x,Q^2) = F_2^{\rm FF,IC}(x,Q^2) -2x F_1^{\rm FF,IC}(x,Q^2)  = \frac{4\frac{m_c^2}{Q^2}}{\sqrt{1+4\frac{m_c^2}{Q^2}}}B_c c^+(\chi)
\end{equation}
...
\end{equation}
\begin{equation}
F_2^{\nu,\rm FF,IC}(x,Q^2)= 2x\left(1+\frac{m_c^2}{Q^2}\right)(|V_{cd}|^2+|V_{cs}|^2)\overline{c}(x)
\end{equation}
\begin{equation}
F_3^{\nu,\rm FF,IC}(x,Q^2)= 2(|V_{cd}|^2+|V_{cs}|^2)\overline{c}(x)
\end{equation}
\begin{equation}
F_L^{\nu,\rm FF,IC}(x,Q^2) = 2x\frac{m_c^2}{Q^2}(|V_{cd}|^2+|V_{cs}|^2)\overline{c}(x)
\end{equation}
\end{subequations}
...
\end{equation}
\begin{equation}
F_2^{\overline{\nu},\rm FF,IC}(x,Q^2)= 2x\left(1+\frac{m_c^2}{Q^2}\right)(|V_{cd}|^2+|V_{cs}|^2)c(x)
\end{equation}
\begin{equation}
F_3^{\overline{\nu},\rm FF,IC}(x,Q^2)= 2(|V_{cd}|^2+|V_{cs}|^2)c(x)
\end{equation}
\begin{equation}
F_L^{\overline{\nu},\rm FF,IC}(x,Q^2)= 2x\frac{m_c^2}{Q^2}(|V_{cd}|^2+|V_{cs}|^2)c(x)
\end{equation}
\end{subequations}
...
\end{equation}
\begin{equation}
F_2^{\rm FF0,IC}(x,Q^2)=xB_cc^+(x)
\end{equation}
\begin{equation}
F_3^{\rm FF0,IC}(x,Q^2)= 2D_cc^-(x)
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
F_2^{\nu,\rm FF0,IC}(x,Q^2)= 2x(|V_{cd}|^2+|V_{cs}|^2)\overline{c}(x)
\end{equation}
\begin{equation}
F_3^{\nu,\rm FF0,IC}(x,Q^2)= 2(|V_{cd}|^2+|V_{cs}|^2)\overline{c}(x)
\end{equation}
\begin{equation}
F_L^{\nu,\rm FF0,IC}(x,Q^2)= 0
\end{equation}
...
\end{equation}
\begin{equation}
F_2^{\overline{\nu},\rm FF0,IC}(x,Q^2)= 2x(|V_{cd}|^2+|V_{cs}|^2)c(x)
\end{equation}
\begin{equation}
F_3^{\overline{\nu},\rm FF0,IC}(x,Q^2)= 2(|V_{cd}|^2+|V_{cs}|^2)c(x)
\end{equation}
\begin{equation}
F_L^{\overline{\nu},\rm FF0,IC}(x,Q^2)= 0
\end{equation}
...
large subleading terms at small energies.
