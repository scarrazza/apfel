...
\begin{equation}
S_+=S_-=2|V_{cs}|^2\quad\mbox{and}\quad R_+=|V_{cs}|^2
\end{equation}
if the outcoming quark is a strange or an anti-strange, and:
\begin{equation}
S_+=S_-=2|V_{cd}|^2\quad\mbox{and}\quad R_+=|V_{cd}|^2
\end{equation}
...
\begin{equation}
\begin{array}{rcl}
2xF_1 &=& \displaystyle \frac{S_+\Sigma_{++}-2m_1m_2S_-}{\Delta}\,x\hat{\mathcal{F}}_1^{QS}\,, \\
\\
F_2 &=& \displaystyle \frac{S_+\Delta}{Q^2} \, x\hat{\mathcal{F}}_2^{QS}\,,\\
\\
xF_3 &=& \displaystyle 2R_+ \,x\hat{\mathcal{F}}_3^{QS}\,.
\end{array}
\end{equation}

In the NC case, where $m_1=m_2=m_c$, $S_+=B_q$, $S_-=\widetilde{B}_q$ and
$R_+=D_q$, the $\mathcal{O}(\alpha_s)$ contributions read:
\begin{equation}
\begin{array}{rcl}
2xF_1^{(1)}(x,Q) &=&\displaystyle \left[1+2\lambda\left(1-\frac{\tilde{B}_c}{B_c}\right)\right] \frac{B_c}{\sqrt{1+4\lambda}}\,x\hat{\mathcal{F}}_1^{QS^{(1)}} \,,\\
\\
F_2^{(1)}(x,Q)&=&\displaystyle B_c\left(\sqrt{1+4\lambda}\right)\,x\hat{\mathcal{F}}_2^{QS^{(1)}}\,,\\
\\
xF_3^{(1)}(x,Q)&=&\displaystyle 2D_c \, x\hat{\mathcal{F}}_3^{QS^{(1)}}\,,\\
\\
F_L^{(1)}(x,Q) &=&\displaystyle \frac{B_c}{\sqrt{1+4\lambda}}\left\{(1+4\lambda)\,x\hat{\mathcal{F}}_2^{QS^{(1)}}-\left[1+2\lambda\left(1-\frac{\tilde{B}_c}{B_c}\right)\right]\,x\hat{\mathcal{F}}_1^{QS^{(1)}} \right\}\,.
\end{array}
\end{equation}
...
the final state,we have $m_1=m_c$ and $m_2=0$, $S_\pm=2(|V_{cs}|^2
+|V_{cd}|^2)$, and $R_+=|V_{cs}|^2+|V_{cd}|^2$, the
$\mathcal{O}(\alpha_s)$ contributions read:
\begin{equation}
\begin{array}{rcl}
2xF_1^{(1)}(x,Q) &=&\displaystyle 2(|V_{cs}|^2
+|V_{cd}|^2)\,x\hat{\mathcal{F}}_1^{QS^{(1)}} \,,\\
\\
F_2^{(1)}(x,Q)&=&\displaystyle 2(|V_{cs}|^2
+|V_{cd}|^2)(1+\lambda)\,x\hat{\mathcal{F}}_2^{QS^{(1)}}\,,\\
\\
xF_3^{(1)}(x,Q)&=&2(|V_{cs}|^2
+|V_{cd}|^2)\, x\hat{\mathcal{F}}_3^{QS^{(1)}}\,,\\
\\
F_L^{(1)}(x,Q) &=&\displaystyle 2(|V_{cs}|^2
+|V_{cd}|^2)\left[(1+\lambda)\,x\hat{\mathcal{F}}_2^{QS^{(1)}}-x\hat{\mathcal{F}}_1^{QS^{(1)}} \right]\,.
\end{array}
\end{equation}
As a further simplification, the parameter $\eta$ to be used in eq.~(\ref{FinalCFonTheGrid}) is equal to one. As a consequence, eq.~(\ref{FinalCFonTheGrid}) reduces to:
\begin{equation}
