...
\begin{equation}
F_1^{\rm FF,IC}(x,Q^2)= \frac{1}{2\sqrt{1+4\lambda}}B_c c^+(\chi)=\frac{1}{2x}\frac{\eta^2}{2-\eta}\left[B_c +\frac{(2-\eta)^2-1}{2\eta^2}(B_c-\tilde{B}_c)\right]\chi c^+(\chi)
\end{equation}
\begin{equation}
...
B_c\left[1-\frac{(2-\eta)^2-1}{8(1-\eta)}\left(1-\frac{\tilde{B}_c}{B_c}\right)\right] \chi c^+(\chi)
%\displaystyle F_L^{\rm FF,IC}(x,Q^2) &=&\displaystyle F_2^{\rm
%FF,IC}(x,Q^2) -2x F_1^{\rm FF,IC}(x,Q^2)  \\
%\\
%&=&\displaystyle \frac{B_c}{2(2-\eta)}\left[\frac{\tilde{B}_c}{B_c}
%(\eta^2-4\eta+3)-(\eta^2+4\eta-5)\right]\chi
%c^+(\chi)
%\end{array}
\end{equation}
...
\begin{equation}
\begin{array}{rcl}
\displaystyle \Delta F_L^{\rm  FONLL,IC}(x_\alpha) &=& \displaystyle\sum_{\beta=0}^{N_x} B_c\left[1-\frac{(2-\eta)^2-1}{8(1-\eta)}\left(1-\frac{\tilde{B}_c}{B_c}\right)\right]
...
It should finally be noticed that the LO coefficient functions of the
grid as written in qes.~(\ref{LONCgrid}) and~(\ref{LOCCgrid}) are
