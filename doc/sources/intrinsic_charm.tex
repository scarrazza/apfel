...
\begin{equation}
F_1^{\rm FF,IC}(x,Q^2)= \frac{1}{2\sqrt{1+4\lambda}}B_c c^+(\chi)=\frac{1}{2x}\frac{\eta^2}{2-\eta}B_c \chi c^+(\chi)
\end{equation}
\begin{equation}
...
F_L^{\rm FF,IC}(x,Q^2) = F_2^{\rm FF,IC}(x,Q^2) -2x F_1^{\rm
  FF,IC}(x,Q^2)  = 4\frac{1-\eta}{2-\eta} B_c \chi c^+(\chi)
\end{equation}
...
\sum_{\beta=0}^{N_x}\left[(2-\eta)
  w_{\beta}^{(k)}\left(\frac{x_\alpha}{\eta}\right) - D(Q^2)\delta_{\alpha\beta}\right]\tilde{c}^+(x_{\beta})
\end{array}
\end{equation}
\begin{equation}
\begin{array}{rcl}
\displaystyle x_\alpha \Delta F_3^{\rm  FONLL,IC}(x_\alpha) & = &\displaystyle D_c
\sum_{\beta=0}^{N_x}\left[2\eta
...
\displaystyle \Delta F_L^{\rm  FONLL,IC}(x_\alpha) &=& \displaystyle
                                                       B_c
\sum_{\beta=0}^{N_x} \left[2\frac{1-\eta}{2-\eta} w_{\beta}^{(k)}\left(\frac{x_\alpha}{\eta}\right)\right]\tilde{c}^+(x_{\beta})
\end{array}
\end{equation}
\end{subequations}
