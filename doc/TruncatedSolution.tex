...
\\
\displaystyle \mathbf{f}^{\rm NLO}(x,\mu) = \mathbf{f}(x,\mu,0)+\frac{\mathbf{f}(x,\mu,\varepsilon)-\mathbf{f}(x,\mu,-\varepsilon)}{2\varepsilon}+\mathcal{O}(\varepsilon^2)\\
\\
\displaystyle \mathbf{f}^{\rm NNLO}(x,\mu) = \mathbf{f}(x,\mu,0)+\frac{\mathbf{f}(x,\mu,\varepsilon)-\mathbf{f}(x,\mu,-\varepsilon)}{2\varepsilon}+\frac{\mathbf{f}(x,\mu,\varepsilon)-2 \mathbf{f}(x,\mu,0)+\mathbf{f}(x,\mu,-\varepsilon)}{2\varepsilon^2}+\mathcal{O}(\varepsilon^2)
\end{array}\,.
\end{equation}
It should be pointed out that the order of the perturbative evolution
of $\alpha_s$ in each of the solutions above must be consistent with
the order to which the solution has been truncated.
...
\\
\displaystyle \mathbf{f}^{\rm NLO}(x,\mu) &=& \displaystyle\mathbf{f}(x,\mu,0)+\frac{-\mathbf{f}(x,\mu,2\varepsilon)+8\mathbf{f}(x,\mu,\varepsilon)-8\mathbf{f}(x,\mu,-\varepsilon)+\mathbf{f}(x,\mu,-2\varepsilon)}{12\varepsilon}+\mathcal{O}(\varepsilon^4)\\
\\
...
\\
&+&\displaystyle\frac{-\mathbf{f}(x,\mu,2\varepsilon)+16\mathbf{f}(x,\mu,\varepsilon)-30 \mathbf{f}(x,\mu,0)+16\mathbf{f}(x,\mu,-\varepsilon)-\mathbf{f}(x,\mu,-2\varepsilon)}{24\varepsilon^2}+\mathcal{O}(\varepsilon^4)
\end{array}\,.
\end{equation}
