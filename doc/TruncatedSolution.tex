...
\mathbf{R}(x,\alpha_s(\mu)) = -\frac1{\alpha_s(\mu)} \sum_{k=0}^{n} \alpha_s^k(\mu) \mathbf{R}^{(k)}(x)
\end{equation}
where:
\begin{equation}
\begin{array}{l}
\displaystyle \mathbf{R}^{(0)}(x) =
\frac{\mathbf{P}^{(0)}(x)}{\beta_0}\\
\\
\displaystyle \mathbf{R}^{(1)}(x) =
\frac{\mathbf{P}^{(1)}(x) - b_1\mathbf{P}^{(0)}(x)}{\beta_0}\\
\\
\displaystyle \mathbf{R}^{(2)}(x) =
\frac{ \mathbf{P}^{(2)}(x) - b_1\mathbf{P}^{(1)}(x) + (
b_1^2 - b_2) \mathbf{P}^{(0)}(x)}{\beta_0}
\end{array}
\end{equation}
where we have defined:
\begin{equation}
...
\mathbf{R}(x,\alpha_s(\mu),\varepsilon) = -\frac1{\alpha_s(\mu)} \left[
...
\\
\displaystyle \mathbf{f}^{\rm NLO}(x,\mu) = \mathbf{f}(x,\mu,0)+\frac{\mathbf{f}(x,\mu,\varepsilon)-\mathbf{f}(x,\mu,-\varepsilon)}{2\varepsilon}+\mathcal{O}(\varepsilon^3)\\
\\
\displaystyle \mathbf{f}^{\rm NNLO}(x,\mu) = \mathbf{f}(x,\mu,0)+\frac{\mathbf{f}(x,\mu,\varepsilon)-\mathbf{f}(x,\mu,-\varepsilon)}{2\varepsilon}+\frac{\mathbf{f}(x,\mu,\varepsilon)-2 \mathbf{f}(x,\mu,0)+\mathbf{f}(x,\mu,-\varepsilon)}{2\varepsilon^2}+\mathcal{O}(\varepsilon^3)
\end{array}
\end{equation}
