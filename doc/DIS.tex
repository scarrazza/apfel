...
\begin{equation}
F(t_R,t_F) / x =
\left[\sum_{k=0}^{2} a_s^k(t_R) \mathcal{C}_i^{(k)}(t_R,t_F)\right]\otimes f_i(t_F) +\mathcal{O}(a_s^3)\,,
\end{equation}
...
functions $\mathcal{C}_i^{(k)}(t_R,t_F)$. In fact:
\begin{equation}\label{ZeroScales}
\begin{array}{rcl}
F(0,0)/x &=&\bigg\{ C_j^{(0)} \\
\\
...
\begin{array}{rcl}
\displaystyle \mathcal{C}_j^{(0)}(t_R,t_F) &=& \displaystyle C_j^{(0)} \\
\\
\displaystyle \mathcal{C}_j^{(1)}(t_R,t_F) &=& \displaystyle C_j^{(1)}-t_F C_i^{(0)} \otimes P_{ij}^{(0)} \\
\\
...
But considering that for $F_2$ and $F_3$:
\begin{equation}
\begin{array}{l}
...
\begin{array}{rcl}
\displaystyle \mathcal{C}_j^{(0)}(t_R,t_F) &=& \displaystyle \delta_{qj}\delta(1-x) \\
\\
\displaystyle \mathcal{C}_j^{(1)}(t_R,t_F) &=& \displaystyle C_j^{(1)}-t_F P_{qj}^{(0)} \\
\\
\displaystyle \mathcal{C}_j^{(2)}(t_R,t_F) &=& \displaystyle C_j^{(2)} + t_R\beta_0 C_j^{(1)}
...
corresponds to what we would call $\mathcal{P}_{ij}^{(1)}(t_R,t_F)$,
...
\begin{array}{rcl}
\displaystyle \mathcal{C}_{\rm NS}^{(0)}(t_R,t_F) &=& \displaystyle \delta(1-x) \\
\\
\displaystyle \mathcal{C}_{\rm NS}^{(1)}(t_R,t_F) &=& \displaystyle
C_{\rm NS}^{(1)}-t_F P_{qq}^{(0)} \\
\\
\displaystyle \mathcal{C}_{\rm NS}^{(2)}(t_R,t_F) &=& \displaystyle C_{\rm NS}^{(2)} + t_R\beta_0 C_{\rm NS}^{(1)}
...
\end{array}
\end{equation}
where NS $=\pm$. In the singlet sector we have exactly eq.~(\ref{generalizedCF1}) with $i,j=g,q(\Sigma)$.

Considering $F_L$, we have that:
\begin{equation}
C_q^{(0)}(x) = C_g^{(0)}(x) = 0
\end{equation}
so that:
