...
When computing structure functions in the massive scheme, there is a
further complication that prevents a fast precomputation of the
cefficient functions on the $x$-space grid.
