...
*
      real SC2mNC(0:ngrid_max,nxir,3,2,0:nint_max_DIS,0:nint_max_DIS)
      real SCLmNC(0:ngrid_max,nxir,3,2,0:nint_max_DIS,0:nint_max_DIS)
*
      real SC2mCC(0:ngrid_max,nxir,3,0:1,0:nint_max_DIS,0:nint_max_DIS)
      real SCLmCC(0:ngrid_max,nxir,3,0:1,0:nint_max_DIS,0:nint_max_DIS)
      real SC3mCC(0:ngrid_max,nxir,3,0:1,0:nint_max_DIS,0:nint_max_DIS)
*
      real SC2m0NC(0:ngrid_max,nxir,3,2,0:nint_max_DIS,0:nint_max_DIS)
      real SCLm0NC(0:ngrid_max,nxir,3,2,0:nint_max_DIS,0:nint_max_DIS)
*
      real SC2m0CC(0:ngrid_max,nxir,3,0:1,0:nint_max_DIS,0:nint_max_DIS)
