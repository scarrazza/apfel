...
*
************************************************************************
      subroutine odeintnsQEDf(i,mu21,mu22,ystart,y)
*
      implicit none
*
...
*
         call rkqsnsQEDf(i,y,dydx,x,h,eps,yscal,hdid,hnext)
*
...
*
************************************************************************
      subroutine rkqsnsQEDf(i,y,dydx,x,htry,eps,yscal,hdid,hnext)
*
      implicit none
*
      include "../commons/grid.h"
...
*
      h = htry
*
 101  call rkcknsQEDf(i,y,dydx,x,h,ytemp,yerr)
*
      errmax = 0d0
      do alpha=0,nin(igrid)
...
*
************************************************************************
      subroutine rkcknsQEDf(i,y,dydx,x,h,yout,yerr)
*
      implicit none
*
      include "../commons/grid.h"
...
*
     ...
     1                + B21 * h * dydx(alpha)
      enddo
      call derivsnsQEDf(i,x+A2*h,ytemp,ak2)
      do alpha=0,nin(igrid)
         ytemp(alpha) = y(alpha) 
     1                + h * ( B31 * dydx(alpha)
     2                +       B32 * ak2(alpha) )
      enddo
      call derivsnsQEDf(i,x+A3*h,ytemp,ak3)
      do alpha=0,nin(igrid)
         ytemp(alpha) = y(alpha) 
     1                + h * ( B41 * dydx(alpha)
     2                +       B42 * ak2(alpha) 
     3                +       B43 * ak3(alpha) )
      enddo
      call derivsnsQEDf(i,x+A4*h,ytemp,ak4)
      do alpha=0,nin(igrid)
         ytemp(alpha) = y(alpha) 
     1                + h * ( B51 * dydx(alpha)
     2                +       B52 * ak2(alpha)
     ...
     4                +       B54 * ak4(alpha) )
      enddo
      call derivsnsQEDf(i,x+A5*h,ytemp,ak5)
      do alpha=0,nin(igrid)
         ytemp(alpha) = y(alpha)
     1                + h * ( B61 * dydx(alpha)
     2                +       B62 * ak2(alpha)
     ...
     5                +       B65 * ak5(alpha) )
      enddo
      call derivsnsQEDf(i,x+A6*h,ytemp,ak6)
      do alpha=0,nin(igrid)
         yout(alpha) = y(alpha)
     1               + h * ( C1 * dydx(alpha)
     2               +       C3 * ak3(alpha)
...
*
************************************************************************
      subroutine derivsnsQEDf(i,t,f,dfdt)
*
      implicit none
*
      include "../commons/PDFEvolution.h"
