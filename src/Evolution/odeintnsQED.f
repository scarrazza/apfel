...
*
************************************************************************
      subroutine odeintnsQED(i,mu21,mu22,ystart,y)
*
      implicit none
*
...
*
         call rkqsnsQED(i,y,dydx,x,h,eps,yscal,hdid,hnext)
*
...
*
************************************************************************
      subroutine rkqsnsQED(i,y,dydx,x,htry,eps,yscal,hdid,hnext)
*
      implicit none
*
      include "../commons/grid.h"
...
*
      h = htry
*
 101  call rkcknsQED(i,y,dydx,x,h,ytemp,yerr)
*
      errmax = 0d0
      do alpha=0,nin(igrid)
         do beta=0,nin(igrid)
...
*
************************************************************************
      subroutine rkcknsQED(i,y,dydx,x,h,yout,yerr)
*
      implicit none
*
      include "../commons/grid.h"
...
*
     ...
     1                        + B21 * h * dydx(alpha,beta)
         enddo
      enddo
      call derivsnsQED(i,x+A2*h,ytemp,ak2)
      do alpha=0,nin(igrid)
         do beta=0,nin(igrid)
           ytemp(alpha,beta) = y(alpha,beta) 
     ...
     2                       +       B32 * ak2(alpha,beta) )
         enddo
      enddo
      call derivsnsQED(i,x+A3*h,ytemp,ak3)
      do alpha=0,nin(igrid)
         do beta=0,nin(igrid)
            ytemp(alpha,beta) = y(alpha,beta) 
     ...
     3                        +       B43 * ak3(alpha,beta) )
         enddo
      enddo
      call derivsnsQED(i,x+A4*h,ytemp,ak4)
      do alpha=0,nin(igrid)
         do beta=0,nin(igrid)
            ytemp(alpha,beta) = y(alpha,beta) 
     ...
     4                        +       B54 * ak4(alpha,beta) )
         enddo
      enddo
      call derivsnsQED(i,x+A5*h,ytemp,ak5)
      do alpha=0,nin(igrid)
         do beta=0,nin(igrid)
            ytemp(alpha,beta) = y(alpha,beta)
     ...
     5                        +       B65 * ak5(alpha,beta) )
         enddo
      enddo
      call derivsnsQED(i,x+A6*h,ytemp,ak6)
      do alpha=0,nin(igrid)
         do beta=0,nin(igrid)
...
*
************************************************************************
      subroutine derivsnsQED(i,t,M,dMdt)
*
      implicit none
*
      include "../commons/PDFEvolution.h"
